...
<html>
  <head>
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB6htqPkYiH2dKVcyOPI32UVaQMyKumDzs&callback=initMap" type="text/javascript"></script>
    ...
    <div class="topbar" id="topbar">
      <div class="wrapper">
        ...
        <a href="#modal_info" class="btn btn-large btn-info" data-toggle="modal"><i class="icon-info-sign icon-white"></i>Sobre o Mapa</a>
            ...
            <? } else { ?>
              <a href="#modal_add" class="btn btn-large btn-success" data-toggle="modal"><i class="icon-plus-sign icon-white"></i>Cadastre-se</a>
            <? } ?>
          </div>
          <div class="share">
          ...
          <fieldset>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="type" id="add_type" class="input-xlarge">
                  ...
                  <option value="service">Outros</option>
                </select>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <p class="help-block">
                  Deve ser o  <b>seu endereço completo (incluindo cidade e CEP)</b>. Se funciona no Google Maps, ele vai funcionar aqui.
                </p>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <p class="help-block">
                Descrição, breve e conciso. Qual é o seu produto? Que problema você resolve? Max 150 caracteres.
                </p>
              </div>
            </div>
          </fieldset>
