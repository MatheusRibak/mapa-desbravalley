...
$lat_lng = "-26.8795318,-53.2834901";

// Domain to use for various links
$domain = "http:://www.desbravalley.com.br";

// Twitter username and default share text
$twitter = array(
  "share_text" => "Vamos colocar a Comunidade Inovadora do Oeste de SC no mapa: "
);

// Short blurb about this site (visible to visitors)
$blurb = "O objetivo deste mapa é promover a Comunidade Inovadora do Oeste de SC - Desbravalley. Vamos colocar a região oeste no mapa!!!";
